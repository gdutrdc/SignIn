 ...
 */
public class DoSignIn extends BaseConnect {
	private String[] studentIds;
	private String[] signInTimes;
	private String classId;

	public DoSignIn(String classId, String[] studentIds, String[] signInTimes, ConnectListener listener) {
		super(listener);
	...
	protected String getTag() {
		return DoSignIn.class.getSimpleName();
	}

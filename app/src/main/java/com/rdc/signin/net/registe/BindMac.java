 ...
 */
public class BindMac extends BaseConnect {
	private User user;
	...
	public BindMac(ConnectListener listener) {
		super(listener);
	...
	protected String getUrl() {
		if (user.getIdentity() == User.IDENTITY_STUDENT)
			return ConnectConfig.BindMac.URL_STD;
		else return ConnectConfig.BindMac.URL_TCH;
	}

	@Override
	protected String getTag() {
		return BindMac.class.getSimpleName();
	}
